...
관리자의 얼굴을 인식하여 인가된 관리자만 시스템에 접근할 수 있고, 관리자의 동공 움직임을 통한 집중도 파악으로 보안성과 설비 안전성을 증대시킬 수 있다.

--------------
포장 x-ray: plc 연동해서 깜빡깜빡 설명
1. 머신 비전을 통해 데이터 받음
2. 얻은 데이터를 통해 머신 러닝을 통해 불량과 정상을 판별
3. 학습된 내용을 바탕으로 설비를 자동화한다.
