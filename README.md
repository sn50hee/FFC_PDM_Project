...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;B. 고장에 위험을 주는 요소는 결과에 얼마나 영향을 미치는지를 기준으로 하여 선별하였다. 아래 사진을 통하여 장비ID(machineID), 회전 수(rotate), 설비 연식(age), 전압(volt), 압력(pressure), 진동 수(vibrationq) 순으로 결과에 영향을 미친다는 것을 확인할 수 있다.

![변수중요도](https://github.com/sn50hee/FFC_PDM_Project/assets/139873815/ca42622b-5fc8-44ff-8cba-569f5f137b9a)
...
&nbsp;&nbsp;&nbsp;&nbsp;A) 2023.12.20(수) ~ 2023.12.22(금): PLC-WPF 연결 및 양방향 통신(성민철)

&nbsp;&nbsp;&nbsp;&nbsp;B) 2023.12.21(목) ~ 2023.12.22(금): UI 수정(윤석희), PLC LD 프로그램 구현(김정관)

&nbsp;&nbsp;&nbsp;&nbsp;C) 2023.12.26(화) ~ 2023.12.27(수): WPF 구현(성민철, 김정관)
